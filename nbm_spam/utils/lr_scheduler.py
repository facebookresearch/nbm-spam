...
class LinearWarmupCosineAnnealingLR(torch.optim.lr_scheduler._LRScheduler):
    """Sets the learning rate of each parameter group to follow a linear
    warmup schedule between warmup_start_lr and base_lr followed by a cosine
    ...
    .. warning::
        ...
        it after each epoch will keep the starting lr at warmup_start_lr for the
        first epoch which is 0 in most cases.
    .. warning::
        ...
        when passing epoch param to :func:`.step()`, the user should call the
        :func:`.step()` function before calling train and validation methods.
    Example:
        ...
        ...     # train(...)
        ...     # validate(...)
    Reproduced from PyTorchLightning/Lightning-Bolts, ref:
    ...
    def __init__(
        ...
        Args:
            ...
            warmup_start_lr (float): Learning rate to start the warmup. Default: 0.
